...
<br> Barrierefreiheit: 1 taktiler Gebäudeplan in Etage 1, Leitsysteme in Etage 0, Etage 3, Etage 4, Etage 7, 10 barrierefreie Toiletten`;
...
var building1Floor1Hallway2 = `Auslegung des Gangs: senkrecht, 12 Uhr-6 Uhr-Gang
...
var building1Floor1Hallway3 = `Auslegung des Gangs: waagrecht, 3 Uhr-9 Uhr-Gang
...
var building1Floor2Hallway1 = `Auslegung des Gangs: senkrecht, 12 Uhr-6 Uhr-Gang, von Wand zu Wand
<br> Länge des Gangs: 5 Meter
...
var building1Floor2Hallway2 = `Auslegung des Gangs: waagrecht, 3 Uhr-9 Uhr-Gang, von Wand zu Wand
<br> Länge des Gangs: 5 Meter
...
<br> Länge des Gangs: 15 Meter
<br> Barrierefreiheit: 2 barrierefreie Toiletten im Gang
<br> Besondere Merkmale: Teppichboden,
...
<br> Länge des Gangs: 10 Meter
<br> Warnung: rutschiger Untergrund, herabhängendes Hindernis vor Raum 215
...
function floorSwitch(selectID1, selectID2, select3) {
    ...
    if (building.value == '1') {
        ...
        if (floor.value == "building1Floor1") {
            var optionArray = ["building1Floor1Hallway1|Gang 1", "building1Floor1Hallway2|Gang 2", "building1Floor1Hallway3|Gang 3"];
        } else if (floor.value == "building1Floor2") {
            var optionArray = ["building1Floor2Hallway1|Gang 1", "building1Floor2Hallway2|Gang 2", "building1Floor2Foyer1|Foyer 1"];
...
function choosingFloorFromBuilding(textID, floorID) {
    switch (floorID) {
        ...
        case 'building2Floor2':
            ...
            break;
        default:
            textID.innerHTML = 'Hier steht die Beschreibung eines Gebäudes, eines Stockwerks oder eines Gangs/Foyers.....';
            break;
    }
}
...
function choosingHallwayFromFloor(textID, hallwayID) {
    ...
    switch (hallwayID) {
        ...
        case 'building1Floor1Hallway2':
            ...
            break;
        case 'building1Floor1Hallway3':
            textID.innerHTML = "Gebäude 1 Stockwerk 1 Gang 3: <br>" + building1Floor1Hallway3;
            break;
        case 'building1Floor2Foyer1':
            textID.innerHTML = "Gebäude 1 Stockwerk 2 Foyer 1: <br>" + building1Floor2Foyer1;
            break;
